...
<head>
  ...
  <title>Edit Bioskop &mdash; Dakota</title>
...
<?php
$kode = $_GET['kode'];
$sql_cek = "SELECT * FROM bioskop WHERE id_bioskop='" . $_GET['kode'] . "'";
...
if (isset($_POST['edit'])) {
  ...
  $nohp = $_POST['nohp'];
    if(empty($nama_cabang)||empty($alamat)||empty($nohp)){
      ...
      $query = mysqli_query($konek, "UPDATE bioskop SET nama_cabang='" . $_POST['cabang'] . "', alamat='" . $_POST['alamat'] . "',nohp='" . $_POST['nohp'] . "' WHERE id_bioskop='$kode'");
      echo "<script>
