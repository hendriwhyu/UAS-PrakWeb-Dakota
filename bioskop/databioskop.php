...
<head>
  ...
  <title>Data Bioskop &mdash; Dakota</title>
        ...
        <section class="section">
          <div class="section-header">
            ...
            <div class="section-header-breadcrumb">
              ...
              <div class="breadcrumb-item">Data Bioskop</div>
            </div>
          </div>
                ...
                <div class="card">
                  <div class="card-header">
                    ...
                    <div class="card-header-action">
                      <a href="tambah.php" title="tambah" class="btn btn-primary btn-sm">
                    ...
                    <div class="table-responsive table-invoice">
                      <table class="table table-striped">
                        ...
                        <tbody>
                          <?php
                          $no = 1;
                          $sql = $konek->query("select * from bioskop ");
                          ...
                          ?>
                            ...
                            <tr>
                              ...
                              <td>
                                <a href="edit.php?kode=<?php echo $data['id_bioskop']; ?>" title="Ubah" class="btn btn-success btn-sm">
                                  <i class="fa fa-edit"></i>
                                </a>
                                <a href="hapus.php?kode=<?php echo $data['id_bioskop']; ?>" onclick="return confirm('Apakah anda yakin hapus data ini ?')" title="Hapus" class="btn btn-danger btn-sm">
